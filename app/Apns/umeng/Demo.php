...
class Demo {
	...
	function sendAndroidUnicast() {
		try {
			$unicast = new AndroidUnicast($device_token);
	...
	function sendIOSUnicast() {
		try {
			...
			$unicast->setPredefinedKeyValue("device_tokens",    "40207f1357d3e879103fa147741da4cde6bf98da1dcf9583322b612e0952fadf");
            ...
            $unicast->setCustomizedField("uid", "20");
...
$demo = new Demo("5699fb8fe0f55a48e60000bb", "8ksy4766fw5bgugapi8eyyw6bkmf2mek");
//$demo->sendIOSUnicast();


$demo1 = new Demo("569a0ac967e58ebe12002438", "21wf6prubvy3audvdf9v4e7tqlugkvuw");
