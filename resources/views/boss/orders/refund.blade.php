...
@section("content")
    <div class="pd-20">
        <div class="goods-nav">
            <a class="@if($state == \App\Models\OrderReturn::STATE_NO_REFUND) active @endif" href="/orders/refund/{{\App\Models\OrderReturn::STATE_NO_REFUND}}">待退款</a>
            <a class="@if($state == \App\Models\OrderReturn::STATE_SUCCESS) active @endif" href="/orders/refund/{{\App\Models\OrderReturn::STATE_SUCCESS}}">已退款</a>
            ...
            <div class="search">
                <form >
                    ...
                    <table class="table table-border table-bordered table-bg">
                        <tr>
                            <td>订单编号:<input type="text" class="input-text ml-10" style="width:250px" value="{{ $tmp['order_no'] }}"  name="order_no"><input type="hidden" name="state" value="{{$state}}"></td>
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            @foreach($orders as  $order)
                <tr class="text-c">
                    ...
                    <td>
                        <a title="查看" href="javascript:;" onclick="a( '订单详情', '/orders/checkDetail/{{$order->order_no}}/1')" class="ml-5" style="text-decoration:none">
