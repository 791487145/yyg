                ...
                callback:function(data){
                    if(data.ret == 'yes') {
                        ...
                        var content = '<div class="col-md-10 mt-10 gift-content"><div class="col-md-1">'+data.goods.id+'</div><div class="col-md-1">'+
                            ...
                            '<input type="hidden" name="gift_add[]" value="'+data.goods.id+'"/><div class="col-md-2 "><a class="c-blue gift-del">删除</a></div></div>';
                        parent.$('.gift_add').remove();
                        parent.$('.gift-add_btn').before(content);
                        parent.gift_remove();
                        layer_close();
