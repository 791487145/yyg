...
@section("content")
    ...
    <form action="/wx/reply/{{$WxReply->id}}/update" id="form" method="post">
    <div style="padding: 20px 20px ">
        <table class="table table-border table-bordered table-hover">
            <tr>
                <td colspan="2">
                    关键字：<input id="txt" type="text" value="{{$WxReply->key_word}}" datatype="*" class="input-text radius" style="width:40%" name="keyword">
                </td>
            </tr>
            <tr>
                <td colspan="2" class="photos">
                    <img src="{{$WxReply->img}}" alt="" width="100" height="100" class="photos">
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td>
                    <input type="hidden" id="remark" name="remark" datatype="*" value="{{$WxReply->remark}}">
                    <input type="hidden" id="type" name="type" datatype="*" value="{{$WxReply->type}}">
                    <input type="hidden" id="create_time" name="create_time" datatype="*" value="{{$WxReply->create_time}}">
                    <input type="hidden" id="media_id" name="media_id" datatype="*" value="{{$WxReply->media_id}}">
