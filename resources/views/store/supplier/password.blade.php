...
@section('content')
    <div class="rightCon">
        <div class="wrap">
            ...
            <form action="{{url('supplier/password')}}" method="post" class="form">
                <div class="box">
                    <h4>修改密码</h4>
                    <ul>
                        <li><p>你将使用<span>{{$supplier->mobile}}</span>手机号接受短信验证</p></li>
    ...
    <script>
        window.onload=function(){
            ...
            send.onclick=function(){
                send.disabled=true;
                //发送短信
                $.get('/auth/sms',{mobile:'{{$supplier->mobile}}','type':3},function(json){
                    if(json.ret == 'yes'){
