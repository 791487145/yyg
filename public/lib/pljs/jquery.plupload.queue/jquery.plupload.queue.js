		...
		target.prepend(
			'<div class="plupload_wrapper plupload_scroll">' +
				'<div id="' + id + '_container" class="plupload_container">' +
					'<div class="plupload">' +
							'<div class="plupload_header_content"></div>' +
			...
			'<div class="plupload_buttons">' +
				'<a href="#" class="plupload_button plupload_add" id="' + id + '_browse">' + _('添加照片') + '</a>' +
			'</div>' 
		);
	}
			...
			this.each(function() {
				...
				uploader.bind("PostInit", function(up) {
					...
					if (up.settings.dragdrop && up.features.dragdrop) {
						$('#' + id + '_filelist').append('<li class="plupload_droptext">' + _("将文件拖动到这里") + '</li>');
					}
				});
